...
abstract class APPPHBP12_Event {}

class APPPHBP12_READ extends APPPHBP12_Event {}

class APPPHBP12_Bloc extends Bloc<APPPHBP12_Event, APPPHBP12SCHEMA> {
  APPPHBP12_Bloc()
      : super(APPPHBP12SCHEMA(
          ItemPick: [''],
    ...
    on<APPPHBP12_READ>((event, emit) {
      return _APPPHBP12_READ(
          APPPHBP12SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
